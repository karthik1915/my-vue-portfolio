<template>
  <div class="z-30 relative overflow-hidden">
    <img alt="Karthikeyan J" src="../../assets/karthikeyan.png" class="rounded-xl max-w-[320px] mx-auto" />
    <svg id="border-svg" class="absolute inset-0 w-full h-full z-20 pointer-events-none"
...
onMounted(() => {
  gsap.fromTo("#border-svg", { scale: 1.5 }, {
    scale: 1, duration: 1,
  })
})
</script>
